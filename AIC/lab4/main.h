...
const int TAM_REORDER=_TAM_REORDER;
#else
...
entrada_btb_t           BTB[_TAM_BUFFER_PREDIC];
...
extern reorder_t	RB[_TAM_REORDER];
...
extern entrada_btb_t    BTB[_TAM_BUFFER_PREDIC];

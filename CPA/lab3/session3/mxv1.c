...
int main(int argc, char *argv[])
{
  ...
  MPI_Scatter(M, n * n, MPI_DOUBLE, Mloc, n * n / tama, MPI_DOUBLE, 0, MPI_COMM_WORLD);
  MPI_Scatter(v, n,     MPI_DOUBLE, vloc, n / tama,     MPI_DOUBLE, 0, MPI_COMM_WORLD);
  ...
  for (iter = 1; iter <= num_iter; iter++) {
    ...
    MPI_Allgather(xloc, n / tama, MPI_DOUBLE, x, n, MPI_DOUBLE, MPI_COMM_WORLD);
  } /* fin del bucle iter */
...
#define ABS(a) ((a) >= 0 ? (a) : -(a))
  ...
  MPI_Reduce(&norma, 1, MPI_DOUBLE, MPI_SUM, 0, MPI_COMM_WORLD);
